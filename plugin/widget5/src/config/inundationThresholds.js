  ...
  createProfile({
    ...
    categories: [
      ...
      },
      {
        ...
        thresholdM: 1.2,
        label: 'Extreme / Critical',
        description: 'Very high modelled depth along exposed road and settlement corridors.',
  ...
  createProfile({
    ...
    categories: [
      ...
      },
      {
        ...
        thresholdM: 0.9,
        label: 'Severe Flooding',
        description: 'Very high modelled depth for low-lying settlement clusters.',
      ...
      },
      {
        ...
        thresholdM: 1.3,
        label: 'Extreme / Critical',
        description: 'Highest modelled depth category for exposed settlement areas.',
